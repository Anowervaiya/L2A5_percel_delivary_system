...
router.patch('/confirm/:id', (0, checkAuth_1.checkAuth)(user_interfaces_1.Role.RECEIVER), percel_controller_1.ParcelController.confirmParcel);
router.patch('/status/:id', (0, checkAuth_1.checkAuth)(user_interfaces_1.Role.ADMIN), percel_controller_1.ParcelController.changeParcelStatus);
